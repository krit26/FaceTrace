...
from models.detectors.fast_mtcnn.utils import detect_face, extract_face
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = os.path.join(
                os.path.dirname(__file__), "../../../weights/fast_mtcnn/pnet.pt"
            )
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = os.path.join(
                os.path.dirname(__file__), "../../../weights/fast_mtcnn/rnet.pt"
            )
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = os.path.join(
                os.path.dirname(__file__), "../../../weights/fast_mtcnn/onet.pt"
            )
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
